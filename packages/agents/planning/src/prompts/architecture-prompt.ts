...
// structurally (ADR-056 Phase 1). `buildStackSubstitutionPrompt` +
// `applyStackSubstitutions` were a regex post-processing workaround
// for single-agent LLM bias across TR_040 → TR_044. The architecture
// crew's per-specialist HARNESS rules + chief reconciliation + the
// `renderStackSection` block make the substitution machinery
// redundant. See TR_052 NRB-3 / TR_053.
