/**
 * Identity config + role mapping repositories — Oracle stubs.
 */
...
const notImplemented = (): never => {
  throw new Error('@gestalt/adapter-oracle identity config: not implemented');
};

export class OracleIdentityConfigRepository implements IdentityConfigRepository {
...
export class OracleRoleMappingRepository implements RoleMappingRepository {
  async healthCheck(): Promise<boolean> { return notImplemented(); }
