/**
 * Deployment event repository — Oracle stub.
 *
 ...
 * throws; when Oracle support is built, replace with a real implementation.
 */

import type { DeploymentEventRepository, DeploymentEventRecord } from '@gestalt/core';

const notImplemented = (): never => {
  throw new Error('@gestalt/adapter-oracle DeploymentEventRepository: not implemented');
};

export class OracleDeploymentEventRepository implements DeploymentEventRepository {
