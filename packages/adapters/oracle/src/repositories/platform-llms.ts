/**
 * Platform LLM repository — Oracle stub.
 *
...
const notImplemented = (): never => {
  throw new Error('@gestalt/adapter-oracle PlatformLLMRepository: not implemented');
};

export class OraclePlatformLLMRepository implements PlatformLLMRepository {
