/**
 * Platform secrets repository — SQL Server stub.
 *
...
const notImplemented = (): never => {
  throw new Error('@gestalt/adapter-mssql PlatformSecretRepository: not implemented');
};

export class MssqlPlatformSecretRepository implements PlatformSecretRepository {
