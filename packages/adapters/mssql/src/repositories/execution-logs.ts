/**
 * Agent execution log repository — SQL Server stub.
 *
...
const notImplemented = (): never => {
  throw new Error('@gestalt/adapter-mssql AgentExecutionLogRepository: not implemented');
};

export class MssqlAgentExecutionLogRepository implements AgentExecutionLogRepository {
