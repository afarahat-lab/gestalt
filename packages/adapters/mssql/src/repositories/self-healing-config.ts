/**
 * Self-healing config repository — SQL Server stub (migration 020).
 *
...
const notImplemented = (): never => {
  throw new Error('@gestalt/adapter-mssql SelfHealingConfigRepository: not implemented');
};

export class MssqlSelfHealingConfigRepository implements SelfHealingConfigRepository {
