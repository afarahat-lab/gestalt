/**
 * Platform groups repository — SQL Server stub (Brief 1, migration 018).
 */
...
const notImplemented = (): never => {
  throw new Error('@gestalt/adapter-mssql PlatformGroupRepository: not implemented');
};

export class MssqlPlatformGroupRepository implements PlatformGroupRepository {
