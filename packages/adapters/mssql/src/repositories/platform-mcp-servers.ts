/**
 * Platform MCP server repository — SQL Server stub.
 */
...
const notImplemented = (): never => {
  throw new Error('@gestalt/adapter-mssql PlatformMcpServerRepository: not implemented');
};

export class MssqlPlatformMcpServerRepository implements PlatformMcpServerRepository {
